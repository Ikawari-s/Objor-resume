...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Duane\PycharmProjects\djangoProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Duane\PycharmProjects\djangoProject\venv\Scripts\deactivate.nu'
